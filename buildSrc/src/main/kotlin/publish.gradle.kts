    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/jmir1/anitomyandroid/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/jmir1/anitomyandroid.git")
                    developerConnection.set("scm:git:ssh://github.com/jmir1/anitomyandroid.git")
                    url.set("https://github.com/jmir1/anitomyandroid/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/jmir1/anitomyandroid/issues")
                }
            }
        }
    }
